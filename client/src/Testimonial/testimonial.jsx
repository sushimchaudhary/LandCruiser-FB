    ...
    <section className="py-16 bg-gray-200">
      <div className="container mx-auto flex flex-col items-center px-4">
        ...
        <div className="w-full max-w-2xl">
          <Slider {...settings}>
            {testimonials.map((t) => (
              <div key={t.id} className="flex flex-col bg-white p-8 rounded-xl shadow-md">
                <p className="text-lg italic text-gray-700 text-center mb-6">"{t.quote}"</p>
                <div className="flex items-center justify-center gap-4 mt-4">
                  ...
                  <div className="flex flex-col text-left">
                    <h5 className="text-md font-semibold text-gray-800">{t.name}</h5>

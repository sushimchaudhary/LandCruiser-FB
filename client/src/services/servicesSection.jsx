...
import { Sparkles, Globe, Compass } from 'lucide-react'; // Import Lucid Icons
    ...
    <>
          ...
          <Row className="justify-content-center mb-10">
            <Col lg="8" className="text-center">
              <div className="inline-flex items-center gap-2 mb-3 text-red-500">
                ...
                <span className="text-lg font-medium uppercase tracking-wider">Explore the Best</span>
              </div>
              <h2 className="text-4xl font-bold text-gray-900">Our Featured Adventures</h2>
      ...
      <section className="py-10 bg-gray-400 text-white">
        <Container className="text-center">
          ...
          <h2 className="text-4xl font-bold mb-4">Ready to Embark on Your Dream Journey?</h2>
          <p className="text-lg mb-8">
            Let us help you plan your next adventure. Browse our tours or contact our
            expert team for personalized assistance.
          </p>
          {/* <Button color="light" size="lg" className="text-red-500 font-bold rounded-full px-8 py-3 hover:bg-white hover:text-red-600 transition-colors duration-300">
            Explore All Tours
          </Button> */}
        </Container>
      </section>
